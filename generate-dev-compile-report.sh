...
mvn gwt:compile -P"gwtdev-compile-report" -Dalt.build.dir=target/ -DskipTests
...
echo -e "\n Just in case you change your mind, you may find the compile report@\e[92m target/extra/dProximityPlaces/compile-report/ \e[39m"
echo -e "\n"
exit 1
fi
